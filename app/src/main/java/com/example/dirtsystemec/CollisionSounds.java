...
public class CollisionSounds {
    private static Sound dropGroundSound;
    private static Sound metallicSound;
    private static Sound burnedSound;
    ...
    public static void init(Audio audio){
        dropGroundSound = audio.newSound("drop_ground_sound.mp3");
        metallicSound = audio.newSound("mettalic_sound.mp3");
        burnedSound = audio.newSound("burned_sound.mp3");
        map = new SparseArray<>();
